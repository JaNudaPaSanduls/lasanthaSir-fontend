...
export default class Update extends React.Component {
  ...
  async componentDidMount() {
    ...
    await axios
      .get("https://class-management-api-9hnm.vercel.app/user/get")
      .then((res) => {
        message.destroy();
        message.open({
          type: "success",
  ...
  async deleteUser() {
    ...
    await axios
      .delete(`https://class-management-api-9hnm.vercel.app/user/delete`)
      .then((res) => {
        message.destroy();
        this.setState({
          hide: "none",
  ...
  async updateUser() {
    ...
    await axios
      .patch(`https://class-management-api-9hnm.vercel.app/user/update`, data)
      .then((res) => {
        console.log(res)
        message.destroy();
        message.open({
